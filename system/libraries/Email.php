...
class CI_Email {
	...
	var	$protocol		= "POP3";	// mail/sendmail/smtp
	var	$smtp_host		= "kran.distriserver.org";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "ceiscomc";		// SMTP Username
	var	$smtp_pass		= "infoceis";		// SMTP Password
	var	$smtp_port		= "995";		// SMTP Port
