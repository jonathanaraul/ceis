...
<div class="box">
  <div class="box-header"> 
    ...
    <ul class="nav nav-tabs nav-tabs-left">
      <li class="active"> <a href="#list" data-toggle="tab"><i class="icon-align-justify"></i> <?php echo get_phrase('student_list');?> </a></li>
      <li> <a href="#add" data-toggle="tab"><i class="icon-plus"></i> <?php echo get_phrase('add_student');?> </a></li>
    </ul>
    <!------CONTROL TABS END-------> 
  </div>
    ...
    <div class="tab-content"> 
      ...
      <div class="tab-pane  active" id="list">
        <center>
          ...
          <br />
          <?php if($class_id	==	''):?>
          <div id="ask_class" class="  alert alert-info  " style="width:300px;"> <i class="icon-info-sign"></i>Por Favor Seleccione un Curso </div>
          <script>
          ...
          <div class="action-nav-normal">
            <div class=" action-nav-button" style="width:300px;"> <a href="#" title="Users"> <img src="<?php echo base_url();?>template/images/icons/user.png" /> <span>Total <?php echo count($students);?> estudiantes</span> </a> </div>
          </div>
        </center>
        <div class="box">
          <div class="box-content">
              ...
              <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive ">
                <thead>
                  <tr>
                    ...
                    <th><div><?php echo get_phrase('tlf_contacto');?></div></th>
      ...
      <div class="tab-pane box" id="add" style="padding: 5px">
        <div class="box-content"> <?php echo form_open('admin/student/create/' , array('class' => 'form-horizontal validatable', 'enctype' => 'multipart/form-data'));?> 
          <script>	
	...
	function mostrarTipoingreso(valor){
		...
		if(valor != 'convenio_sena')
          ...
          <div class="padded">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="datepicker fill-up" name="fchaexp"/>
              </div>
            </div>
            <div class="control-group">
       ...
       aqui aparecen campos nuevo
            ...
            <div class="control-group">
              ...
              <div class="controls" style="width:210px;"> <img id="blah" src="<?php echo base_url();?>uploads/user.jpg" alt="your image" height="100" /> </div>
            </div>
          </div>
...
<center>
  <div class="span5" style="float:none !important;">
    <div class="box">
      <div class="box-header"> <span class="title"> <i class="icon-info-sign"></i><?php echo get_phrase('alert_studinate');?></span> </div>
