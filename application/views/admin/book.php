            ...
            <div class="tab-pane box active" id="list">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive box">
                    ...
                    <tr>
                        ...
                        <th>
                            <div><?php echo get_phrase('book_name'); ?></div>
                        </th>
                        <th>
                    ...
                    foreach ($books as $row): ?>
                        <tr>
                            ...
                            <td><span
                                    class="label label-<?php if ($row['status'] == 'available') echo 'green'; else echo 'dark-red'; ?>"><?php echo $row['status']; ?></span>
                            </td>
                            <td align="center">
                                <a data-toggle="modal" href="#modal-form"
                                   onclick="modal('edit_book',<?php echo $row['book_id']; ?>)"
                                   class="btn btn-gray btn-small">
                                    <i class="icon-wrench"></i> <?php echo get_phrase('edit'); ?>
                                </a>
                                <a data-toggle="modal" href="#modal-delete"
                                   onclick="modal_delete('<?php echo base_url(); ?>index.php?admin/book/delete/<?php echo $row['book_id']; ?>')"
