            ...
            <?php if (isset($edit_profile)): ?>
                <div class="tab-pane box active" id="edit" style="padding: 5px">
                    <div class="box-content">
                        ...
                        <div class="row-fluid">
                            ...
                            foreach ($language_phrases as $row) {
                                ...
                                <div class="span3">
                                    <div class="box">
                                        <div class="box-header">
                                            <span class="title"><i class="icon-th-list"></i> <?php echo $count++; ?>
                                                . <?php echo $row['phrase']; ?></span>
                                        </div>
                                        ...
                                        <div class="box-content padded">
                                            ...
                                            <input type="text" name="phrase<?php echo $row['phrase_id']; ?>"
                                                   value="<?php echo $phrase_language; ?>"
                        ...
                        <input type="submit" value="<?php echo get_phrase('update_phrase'); ?>"
                               onClick="document.getElementById('phrase_form').submit();" class="btn btn-blue"/>
                        <?php
                        echo form_close();
                        ?>
