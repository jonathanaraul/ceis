 ...
 <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <select name="documento" class="uniform" style="width:100%;">
                                    	...
                                    	<option value="CC" <?php if($row['documento'] == 'CC')echo 'selected';?>><?php echo get_phrase('CEDULA_DE_CIUDADANIA');?></option>

                                    	<option value="CE" <?php if($row['documento'] == 'CE')echo 'selected';?>><?php echo get_phrase('CEDULA_DE_EXTRANJERIA');?></option>
                                        	<option value="VISA" <?php if($row['documento'] == 'VISA')echo 'selected';?>><?php echo get_phrase('VISA');?></option>
...
<div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="validate[required]" name="lexpedicion" value="<?php echo $row['lexpedicion'];?>"/>
                             ...
                             <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <select name="estado_civil" class="uniform" style="width:100%;">
                                    	...
                                    	<option value="Soltero" <?php if($row['estado_civil'] == 'Soltero')echo 'selected';?>><?php echo get_phrase('Soltero');?></option>

                                    	<option value="casado" <?php if($row['estado_civil'] == 'casado')echo 'selected';?>><?php echo get_phrase('casado');?></option>
                                                                            	<option value="Separado" <?php if($row['estado_civil'] == 'Separado')echo 'selected';?>><?php echo get_phrase('Separado');?></option>
                                                                                                                    	<option value="Union_Libre" <?php if($row['estado_civil'] == 'Union_Libre')echo 'selected';?>><?php echo get_phrase('Union_Libre');?></option>
                                                                                                                                                            	<option value="Viudo" <?php if($row['estado_civil'] == 'Viudo')echo 'selected';?>><?php echo get_phrase('Viudo');?></option>
