    ...
    3px solid #400000; border-radius: 10px; width: 380px; font-size: 17px; text-align: center;">
        ...
        <div class="titulo" style=" width:300px; height: 50px; font-size: 20px; margin-left: 165px; margin-top: 170px;">CERTIFICACIÓN DE ESTUDIOS</div>
        ...
        cursó estudios en esta institucion durante el periodo , culminando con exito el curso <span style="font-size:15px; font-weight:bold;"><?= $this->crud_model->get_hs_cursos_nombre($elements[0]['curso'])?></span>, con
