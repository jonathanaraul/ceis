                            ...
                            <td align="center" class="span5">
                                ...
                                <a
                                    ...
                                    <a
                                        ...
                                        onclick="modal_delete('<?php echo base_url(); ?>index.php?site/student/<?php echo $class_id; ?>/delete/<?php echo $row['student_id']; ?>')"
                                        class="btn btn-red btn-small"> <i
                                            class="icon-trash"></i> <?php echo get_phrase('delete'); ?> </a>
                               

                                <!--<a href="<?php echo base_url(); ?>index.php?site/student/<?php echo $class_id; ?>/personal_profile/<?php echo $row['student_id']; ?>"
                                        ...
                                        <a href="<?php echo base_url(); ?>index.php?site/student/<?php echo $class_id; ?>/academic_result/<?php echo $row['student_id']; ?>"
                                        ...
                                        <a href="<?php echo base_url(); ?>index.php?site/student/<?php echo $class_id; ?>/edit/<?php echo $row['student_id']; ?>"
                                        ...
                                        <a href="<?php echo base_url(); ?>index.php?site/student/<?php echo $class_id; ?>/delete/<?php echo $row['student_id']; ?>" onclick="return confirm('delete?')"
...
<div
    class="box-content"> <?php echo form_open('site/student/create/', array('class' => 'form-horizontal validatable', 'enctype' => 'multipart/form-data')); ?>
<script>
...
<div class="control-group divconvenio_sena" style="display: none;">
    ...
    <div class="controls">
        <select name="nom_departamento" class="uniform" style="width:100%;"
                onchange="mostrarCodDepartamento(this.value);">
            <option value="Atlantico"><?php echo get_phrase('Atlantico'); ?></option>
            <option value="Bolivar"><?php echo get_phrase('Bolivar'); ?></option>
            <option value="Magdalena"><?php echo get_phrase('Magdalena'); ?></option>
            <option value="Cesar"><?php echo get_phrase('Cesar'); ?></option>
...
<div class="control-group divconvenio_sena" style="display: none;">
    <label class="control-label"
           id="label-codigo-departamento-sena"><?php echo get_phrase('codigo_departamento'); ?></label>
...
<div class="control-group divconvenio_sena" style="display: none;">
    ...
    <div class="controls">
        <select name="caracterizacion" class="uniform" style="width:100%;">
            ...
            <option
                value="INDIGENAS DESPLAZADOS POR LA VIOLENCIA"><?php echo get_phrase('INDIGENAS_DESPLAZADOS_POR_LA VIOLENCIA'); ?></option>
            <option
                value="INDIGENAS DESPLAZADOS POR LA VIOLENCIA CABEZA DE FAMILIA"><?php echo get_phrase('INDIGENAS_DESPLAZADOS_POR_LA_VIOLENCIA_CABEZA_DE_FAMILIA'); ?></option>
            <option
                value="DESPLAZADOS POR LA VIOLENCIA "><?php echo get_phrase('DESPLAZADOS_POR_LA_VIOLENCIA '); ?></option>
            <option
                value="DESPLAZADOS POR LA VIOLENCIA CABEZA DE FAMILIA "><?php echo get_phrase('DESPLAZADOS_POR_LA_VIOLENCIA_CABEZA_DE_FAMILIA'); ?></option>
            <option
                value="AFROCOLOMBIANOS DESPLAZADOS POR LA VIOLENCIA"><?php echo get_phrase('AFROCOLOMBIANOS_DESPLAZADOS_POR_LA_VIOLENCIA'); ?></option>
            <option value="DESPLAZADOS DISCAPACITADOS"><?php echo get_phrase('DESPLAZADOS_DISCAPACITADOS'); ?></option>
            <option
                value="DESPLAZADOS POR FENOMENOS NATURALES "><?php echo get_phrase('DESPLAZADOS_POR_FENOMENOS_NATURALES '); ?></option>
            ...
            <option
                value="ADOLESCENTE EN CONFLICTO CON LA LEY PENAL"><?php echo get_phrase('ADOLESCENTE_EN_CONFLICTO_CON_LA_LEY_PENAL'); ?></option>
            ...
            <option
                value="ADOLESCENTE DESVINCULADO DE GRUPOS ARMADOS ORGANIZADOS"><?php echo get_phrase('ADOLESCENTE_DESVINCULADO_DE_GRUPOS_ARMADOS_ORGANIZADOS'); ?></option>
            ...
            <option
                value="SOBREVIVIENTES MINAS ANTIPERSONALES"><?php echo get_phrase('SOBREVIVIENTES_MINAS_ANTIPERSONALES'); ?></option>
