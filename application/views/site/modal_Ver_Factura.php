<div class="tab-pane box active" id="edit" style="padding: 20px">
    ...
    <div class="box-content">
        <?php foreach ($edit_data as $row): ?>
            ...
            <div class="pull-left">
            <span style="font-size:20px;font-weight:100;"> Pagar a
            </span>
                <br/>
                <?= "CEIS"; ?>
                <br/>
            ...
            <span style="font-size:20px;font-weight:100;">
                ...
                <br/>
                <?php foreach ($this->crud_model->get_student_info($row['estudiante']) as $student)
                      echo  "C.I : ". $student['cedula']."<br>";
                      echo  "Nombre : ". $student['papellido']." ". $student['nombre'];
                ?>
                <br/>
                <?= get_phrase('curso'); ?> :
                <?php
                ...
                <tr>
                    ...
                    <td width="30%" style="padding:5px;">
                        <div class="pull-right">
                            ...
                            <br/>
                            <?php echo get_phrase('invoice_id'); ?> : <?php echo "Est-Fac-". $row['id']; ?>
                            <br/>
