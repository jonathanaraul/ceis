                            ...
                            <div id="dataTables">
                                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive ">
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <div><?php echo get_phrase('relation_with_student'); ?></div>
                                        </th>
                                        <th>
                                            <div><?php echo get_phrase('parent_email'); ?></div>
                                        </th>
                                        <th>
                                            <div><?php echo get_phrase('parent_phone'); ?></div>
                                        </th>
                                        <th>
                                            <div><?php echo get_phrase('parrent_address'); ?></div>
                                        </th>
                                        <th>
                                            <div><?php echo get_phrase('parrent_occupation'); ?></div>
                                        </th>
                                        <th>
                                            ...
                                            <td align="center" class="span5">
                                                ...
                                                if (empty($parent_info)):
                                                    ...
                                                    <a data-toggle="modal" href="#modal-form"
                                                       onclick="modal('add_parent',<?php echo $row['student_id']; ?>,<?php echo $class_id; ?>)"
                                                ...
                                                <?php
                                                    ...
                                                    ?>
                                                    <a data-toggle="modal" href="#modal-form"
                                                       onclick="modal('edit_parent',<?php echo $parent_info->parent_id; ?>,<?php echo $class_id; ?>)"
