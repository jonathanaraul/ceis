            ...
            <div class="tab-pane box active" id="list">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                    ...
                    <tr>
                        ...
                        <th>
                            <div><?php echo get_phrase('grade_name'); ?></div>
                        </th>
                        <th>
                        ...
                        <th>
                            <div><?php echo get_phrase('comment'); ?></div>
                        </th>
                        <th>
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <a data-toggle="modal" href="#modal-form"
                                   onclick="modal('edit_grade',<?php echo $row['grade_id']; ?>)"
                                   class="btn btn-gray btn-small">
                                    <i class="icon-wrench"></i> <?php echo get_phrase('edit'); ?>
                                </a>
                                <a data-toggle="modal" href="#modal-delete"
                                   onclick="modal_delete('<?php echo base_url(); ?>index.php?admin/grade/delete/<?php echo $row['grade_id']; ?>')"
