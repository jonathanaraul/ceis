...
foreach ($student_info as $row):?>
    ...
    <div
        style="background-color: #ddd;text-align: left;color: #fff;font-size: 21px;font-weight: 100;padding-left:20px;margin-top:60px;">
    ...
    <table width="100%" border="0" style="background-color:#fff; font-size:13px;">
        ...
        <tr>
            ...
            <td class="idcard_text"
                style="padding-top:16px;"><?php echo $row['name']; ?> <?php echo $row['snombre']; ?> <?php echo $row['papellido']; ?> <?php echo $row['sapellido']; ?></td>
