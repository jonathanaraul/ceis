                                ...
                                <div class="controls">
                                    ...
                                    if ($row['type'] == 'text_direction'):?>
                                        ...
                                        <select name="description">
                                            ...
                                            <option
                                                value="left_to_right" <?php if ($row['description'] == 'left_to_right') echo 'selected'; ?> >
                                                <?php echo get_phrase('left_to_right'); ?></option>

                                            <option
                                                value="right_to_left" <?php if ($row['description'] == 'right_to_left') echo 'selected'; ?> >
                                                <?php echo get_phrase('right_to_left'); ?></option>

                                        </select>
                                        <button type="submit"
                                                class="btn btn-blue"><?php echo get_phrase('save'); ?></button>
                                        <?php continue; endif; ?>
                                    <!---RTL , LTR SETTINGS--->
